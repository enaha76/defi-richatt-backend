...
@InputType()
class DictionaryEntryCreateNestedManyWithoutUsersInput {
...
export { DictionaryEntryCreateNestedManyWithoutUsersInput as DictionaryEntryCreateNestedManyWithoutUsersInput };
