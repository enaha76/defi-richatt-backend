...
@InputType()
class AiSuggestionCreateNestedManyWithoutUsersInput {
...
export { AiSuggestionCreateNestedManyWithoutUsersInput as AiSuggestionCreateNestedManyWithoutUsersInput };
