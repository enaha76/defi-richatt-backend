...
@InputType()
class DictionaryEntryCreateNestedManyWithoutRootsInput {
...
export { DictionaryEntryCreateNestedManyWithoutRootsInput as DictionaryEntryCreateNestedManyWithoutRootsInput };
