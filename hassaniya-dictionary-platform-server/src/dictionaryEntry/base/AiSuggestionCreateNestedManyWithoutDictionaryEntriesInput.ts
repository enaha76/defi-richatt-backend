...
@InputType()
class AiSuggestionCreateNestedManyWithoutDictionaryEntriesInput {
...
export { AiSuggestionCreateNestedManyWithoutDictionaryEntriesInput as AiSuggestionCreateNestedManyWithoutDictionaryEntriesInput };
