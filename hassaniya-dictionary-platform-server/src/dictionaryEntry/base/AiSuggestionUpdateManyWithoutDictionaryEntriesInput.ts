...
@InputType()
class AiSuggestionUpdateManyWithoutDictionaryEntriesInput {
...
export { AiSuggestionUpdateManyWithoutDictionaryEntriesInput as AiSuggestionUpdateManyWithoutDictionaryEntriesInput };
