...
@InputType()
class ExampleUpdateManyWithoutDictionaryEntriesInput {
...
export { ExampleUpdateManyWithoutDictionaryEntriesInput as ExampleUpdateManyWithoutDictionaryEntriesInput };
