...
@InputType()
class ActivityUpdateManyWithoutDictionaryEntriesInput {
...
export { ActivityUpdateManyWithoutDictionaryEntriesInput as ActivityUpdateManyWithoutDictionaryEntriesInput };
