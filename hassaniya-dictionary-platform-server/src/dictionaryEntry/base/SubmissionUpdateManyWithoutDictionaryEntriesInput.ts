...
@InputType()
class SubmissionUpdateManyWithoutDictionaryEntriesInput {
...
export { SubmissionUpdateManyWithoutDictionaryEntriesInput as SubmissionUpdateManyWithoutDictionaryEntriesInput };
