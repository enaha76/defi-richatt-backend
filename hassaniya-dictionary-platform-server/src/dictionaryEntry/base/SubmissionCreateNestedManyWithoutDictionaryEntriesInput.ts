...
@InputType()
class SubmissionCreateNestedManyWithoutDictionaryEntriesInput {
...
export { SubmissionCreateNestedManyWithoutDictionaryEntriesInput as SubmissionCreateNestedManyWithoutDictionaryEntriesInput };
